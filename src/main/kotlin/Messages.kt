class Messages {
    companion object {
        ...
        const val helpMessage =
            "Hints: /start for begin work, /park for park your car, /return for take your car, /park_info_by_car for find car by registration number, /park_info_by_place for check parking slot, /end for close assistant"
        ...
        const val emptyMessage = "Invalid input, try again!"
        ...
        const val invalidFormat = "Data format incorrect!"
        const val slotMessage = "This car parked at slot "
    }
}
